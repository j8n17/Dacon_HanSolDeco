...
Google Gemma 3 계열 중 [gemma3:4b](https://ollama.com/library/gemma3%3A4b) (instruction-tuned) 모델을 사용했습니다.

* 128 K 토큰 컨텍스트 윈도우
* 멀티모달 입력(텍스트 + 이미지) 및 140+ 개 언어 지원
* 단일 GPU에서도 구동 가능한 경량 설계
* **선정 이유**: 한국어 처리 성능을 중점적으로 실험한 결과, Gemma3:4B가 한국어 문장 이해 및 생성에서 우수한 품질을 보여 선택하였습니다.
